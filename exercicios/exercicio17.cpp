...
int main(){
  ...
  cout << "Digite 1 se voce quer comprar só em latas;\n";
  cout << "Digite 2 se voce quer comprar só em galoes;\n";
  cout << "Digite 3 se voce quer comprar em latas e galoes ao mesmo tempo;\n";
